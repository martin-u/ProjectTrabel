...
namespace Dao
{
    public class ViajeDao: Conexion
    {
        ...
        public static List<ViajeEntidad> consultarViaje()
        {
            ...
            string query = "SELECT * FROM Viaje v JOIN CiudadOrigenn c ON (v.idCiudadOrigen = c.idCiudadOrigen) JOIN CiudadDestino cd ON (cd.idCiudadDestino = v.idCiudadDestino)";
            SqlCommand cmd = new SqlCommand(query, obtenerDB());
